  ...
  list: [
    {
      ...
      content:
        '您的用户ID4533452342于2021-02-09 07:45:23进行了登录操作。如非本人操作，账号可能被盗。建议立即修改密码，或在[设置-账号与安全-登录设备管理]中删除异常设备。参考设备：iPhone X参考地点：上海市'
    },
    {
      read: false,
      title: '账号登录提醒',
    ...
    },
    {
      ...
      time: '2021-10-12 12:12',
      content:
        '你好，根据业务开展的实际情况，蘑菇近期更新了《蘑菇用户服务协议》《蘑菇隐私政策》及《儿童/青少年使用须知》中的相关内容。你可以在“我”-“设置”页面中，查看更新后的协议全文。'
    },
    {
      read: false,
      title: '协议修订通知',
      ...
      time: '2021-10-12 12:12',
      content:
        '你好，根据业务开展的实际情况，蘑菇近期更新了《蘑菇用户服务协议》部分条款的表述。你可以在“我”-“设置”页面中，查看更新后的协议全文。'
    }
  ]
})
